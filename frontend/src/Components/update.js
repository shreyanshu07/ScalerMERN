...
const AddRooms = () => { 
    ...
    fetchHandler().then((data) => {
        ...
        dataArray.forEach(element => {
            if(element._id===id){
                ...
                setCustomerMailId(element.CustomerMailId)
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_wv0l4kr', 'template_mf77nqn', e.target, 'Mj-g54EA7pWTXLZ5R')
      .then((result) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
        ...
        >
          ...
          <TextField1 label="End Date (MM/DD/YYYY)" value={EndDate}  onChange={(e) => setEndDateFunction(e)} margin="normal" fullWidth variant="outlined" name="Sdate"/>
